					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Project Movement Data</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $reportTable->currentProject;?></td>
												<td><?php echo $reportTable->reqByname.' '.$reportTable->reqBylname;?></td>
                                                <td><?php echo $reportTable->pm_reason;?></td>
